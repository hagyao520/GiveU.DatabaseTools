...
public class StringUtil2_1920x1080 {
...
//	}		
	...
	public static boolean CustomerContractButton(String DataVersion,String ID_SA){
	    ...
	    String sql = "select rownum,c.* from dafy_sales.cs_credit c where ID_SA="+ID_SA+" order by COMMIT_TIME DESC";
...
//			    + " and rownum<10000";
	...
	public static void TableView(JTable tabDemo){  
        ...
        databasetools.ui.frame.HomePageWindow2_1920x1080.DataDisplayList.getViewport().add(tabDemo); 
