...
public class HomePageWindow2_1600x900  extends JFrame{
	...
	public static HomePageWindow2_1600x900 getInstance() {
		HomePageWindow2_1600x900 inst = new HomePageWindow2_1600x900();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public HomePageWindow2_1600x900() {
		super();
		initGUI();
		initTrayIcon();
		initFocusListener();
...
//			  }
			...
			DataDisplayList.setBounds(730,10,860,680);
			//设置背景是否透明
...
//			EvaluationOfInternalCodeRegistrationCodeTextField.setText("请输入评定内部注册代码...");
			...
			contractLabel.setBounds(930, 720, 70, 20);
			MainPanel.add(contractLabel);
			
			contractField = new JTextField();
			contractField.setBounds(1000, 715, 240, 28);
			...
			InquiryContractExpensesButton.setBounds(1260, 715, 120, 30);
			...
			SQLLabel.setBounds(930, 770, 70, 20);
			...
			SQLScroll.setBounds(1000, 750, 240, 60);
	...
	private void initFocusListener() {
		...
		UserInfoTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (StringUtil2_1600x900.isEmpty(contract_no)) {
					UserInfoTextField.setText("请输入用户ID...");
				}	
			}
			@Override
		...
		SQLArea.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (StringUtil2_1600x900.isEmpty(SQL)) {
					SQLArea.setText("请输入SQL...");
				}
			}
			@Override
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1600x900.UserIDcompare(DataVersion,User_ID)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
					StringUtil2_1600x900.UserInfoButton(DataVersion,User_ID);
				}
		    }
		});
...
//		});		
		...
		CityBoundContractModeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.CityBoundContractModeButton(DataVersion,city);
		    }
		});
...
//					return;
//				}
//				StringUtil2_1600x900.StoreBoundCommodityTypeButton(DataVersion,POS_CODE);
//		    }
//		});		
		...
		StoreBoundProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.StoreBoundProductVersionButton(DataVersion,POS_CODE);
		    }
		});			
		...
		ProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.ProductVersionButton(DataVersion,REG_VAL_CODE,REG_NUMBER);
		    }
		});			
		...
		ProductInformationButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.ProductInformationButton(DataVersion,credit_model,GOODS_CA_ID,search_type,prod_type,INIT_PAY,STATUS);
		    }
		});			
		...
		InsuranceFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.InsuranceFeeButton(DataVersion,LoanPrincipal,InsuranceRate,ProductVersionCode);
		    }
		});		
		...
		TreasureBoxFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.TreasureBoxFeeButton(DataVersion,LoanPrincipal,TreasureBoxRate,ProductVersionCode);
		    }
		});			
		...
		MallCouponsFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MallCouponsFeeButton(DataVersion,LoanPrincipal,MallCouponsRate,ProductVersionCode);
		    }
		});				
		...
		EachPeriodShouldBeReturnedFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.EachPeriodShouldBeReturnedFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ProductVersionCode);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1600x900.EducationalLevelButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1600x900.HousingSituationButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1600x900.MaritalStatusButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1600x900.IndustryCategoryButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1600x900.UnitPropertiesButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1600x900.PositionButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1600x900.WorkingLifeButton(DataVersion,null);
		    }
		});			
...
////					return;
////				}
//				StringUtil2_1600x900.SupportBankButton(DataVersion,null);
//		    }
//		});			
...
////					return;
////				}
//				StringUtil2_1600x900.EvaluationOfInternalCodeButton(DataVersion,null);
//		    }
//		});			
		...
		SMSAuthorizationAuthenticationCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.SMSAuthorizationAuthenticationCodeButton(DataVersion,mobile);
		    }
		});		
		...
		CustomerContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.CustomerContractButton(DataVersion,ID_SA);
		    }
		});			
		...
		RepaymentsForEachPeriodFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.RepaymentsForEachPeriodFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ComprehensiveInsuranceFee,ProductVersionCode);
		    }
		});			
		...
		MonthlyReturnFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyReturnFeeButton(DataVersion,LoanPrincipal,ProductVersionCode);
		    }
		});			
		...
		MonthlyWeShouldAlsoPrincipalFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyWeShouldAlsoPrincipalFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyPayableFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyPayableFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyConsultingFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyConsultingFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyServiceFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyServiceFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});			
		...
		MonthlyLoanInterestRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.MonthlyLoanInterestRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		ContractStateUpdateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.ContractStateUpdateButton(DataVersion,ContractNumber,ContractState);
		    }
		});		
		...
		ShortMessageSignatureCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.ShortMessageSignatureCodeButton(DataVersion,mobile);
		    }
		});		
		...
		PDFSigningContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.PDFSigningContractButton(DataVersion,ContractNumber);
		    }
		});		
		...
		SignatureRecordDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					StringUtil2_1600x900.SignatureRecordDeleteButton(DataVersion,ContractID,ContractNumber);
		...
		StoredProcedureExecutionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.StoredProcedureExecutionButton(DataVersion,StoredProcedureName,ContractNumber,ContractID);
		    }
		});			
		...
		ReimbursementPlanQueryButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1600x900.ReimbursementPlanQueryButton(DataVersion,ContractID);
		    }
		});			
		...
		ReimbursementPlanDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					StringUtil2_1600x900.ReimbursementPlanDeleteButton(DataVersion,ContractID);
				} catch (SQLException e1) {
					e1.printStackTrace();
				}
		    }
		...
		InquiryContractExpensesButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1600x900.contractcompare(DataVersion,contract_no)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
				StringUtil2_1600x900.InquiryContractExpensesButton(DataVersion,contract_no);
		    }
		});	
		...
		SQLButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1600x900.isEmpty1(Sql)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
		        StringUtil2_1600x900.SQLButton(DataVersion,Sql);
		    }
		});			
	}	
}
