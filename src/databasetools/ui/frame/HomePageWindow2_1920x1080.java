...
public class HomePageWindow2_1920x1080  extends JFrame{
	...
	public static HomePageWindow2_1920x1080 getInstance() {
		HomePageWindow2_1920x1080 inst = new HomePageWindow2_1920x1080();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public HomePageWindow2_1920x1080() {
		super();
		initGUI();
		initTrayIcon();
		initFocusListener();
	...
	private void initFocusListener() {
		...
		SQLArea.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (StringUtil2_1920x1080.isEmpty(SQL)) {
					SQLArea.setText("请输入SQL...");
				}
			}
			@Override
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1920x1080.UserIDcompare(DataVersion,User_ID)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
					StringUtil2_1920x1080.UserInfoButton(DataVersion,User_ID);
				}
		    }
		});
...
//		});		
		...
		CityBoundContractModeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.CityBoundContractModeButton(DataVersion,city);
		    }
		});
...
//					return;
//				}
//				StringUtil2_1920x1080.StoreBoundCommodityTypeButton(DataVersion,POS_CODE);
//		    }
//		});		
		...
		StoreBoundProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.StoreBoundProductVersionButton(DataVersion,POS_CODE);
		    }
		});			
		...
		ProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.ProductVersionButton(DataVersion,REG_VAL_CODE,REG_NUMBER);
		    }
		});			
		...
		ProductInformationButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.ProductInformationButton(DataVersion,credit_model,GOODS_CA_ID,search_type,prod_type,INIT_PAY,STATUS);
		    }
		});			
		...
		InsuranceFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.InsuranceFeeButton(DataVersion,LoanPrincipal,InsuranceRate,ProductVersionCode);
		    }
		});		
		...
		TreasureBoxFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.TreasureBoxFeeButton(DataVersion,LoanPrincipal,TreasureBoxRate,ProductVersionCode);
		    }
		});			
		...
		MallCouponsFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MallCouponsFeeButton(DataVersion,LoanPrincipal,MallCouponsRate,ProductVersionCode);
		    }
		});				
		...
		EachPeriodShouldBeReturnedFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.EachPeriodShouldBeReturnedFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ProductVersionCode);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1920x1080.EducationalLevelButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1920x1080.HousingSituationButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1920x1080.MaritalStatusButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1920x1080.IndustryCategoryButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1920x1080.UnitPropertiesButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				StringUtil2_1920x1080.PositionButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				StringUtil2_1920x1080.WorkingLifeButton(DataVersion,null);
		    }
		});			
...
////					return;
////				}
//				StringUtil2_1920x1080.SupportBankButton(DataVersion,null);
//		    }
//		});			
...
////					return;
////				}
//				StringUtil2_1920x1080.EvaluationOfInternalCodeButton(DataVersion,null);
//		    }
//		});			
		...
		SMSAuthorizationAuthenticationCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.SMSAuthorizationAuthenticationCodeButton(DataVersion,mobile);
		    }
		});		
		...
		CustomerContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.CustomerContractButton(DataVersion,ID_SA);
		    }
		});			
		...
		RepaymentsForEachPeriodFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.RepaymentsForEachPeriodFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ComprehensiveInsuranceFee,ProductVersionCode);
		    }
		});			
		...
		MonthlyReturnFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyReturnFeeButton(DataVersion,LoanPrincipal,ProductVersionCode);
		    }
		});			
		...
		MonthlyWeShouldAlsoPrincipalFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyWeShouldAlsoPrincipalFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyPayableFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyPayableFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyConsultingFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyConsultingFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyServiceFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyServiceFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});			
		...
		MonthlyLoanInterestRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.MonthlyLoanInterestRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		ContractStateUpdateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.ContractStateUpdateButton(DataVersion,ContractNumber,ContractState);
		    }
		});		
		...
		ShortMessageSignatureCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.ShortMessageSignatureCodeButton(DataVersion,mobile);
		    }
		});		
		...
		PDFSigningContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.PDFSigningContractButton(DataVersion,ContractNumber);
		    }
		});		
		...
		SignatureRecordDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					StringUtil2_1920x1080.SignatureRecordDeleteButton(DataVersion,ContractID,ContractNumber);
		...
		StoredProcedureExecutionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.StoredProcedureExecutionButton(DataVersion,StoredProcedureName,ContractNumber,ContractID);
		    }
		});			
		...
		ReimbursementPlanQueryButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				StringUtil2_1920x1080.ReimbursementPlanQueryButton(DataVersion,ContractID);
		    }
		});			
		...
		ReimbursementPlanDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					StringUtil2_1920x1080.ReimbursementPlanDeleteButton(DataVersion,ContractID);
				} catch (SQLException e1) {
					e1.printStackTrace();
				}
		    }
		...
		InquiryContractExpensesButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1920x1080.contractcompare(DataVersion,contract_no)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
				StringUtil2_1920x1080.InquiryContractExpensesButton(DataVersion,contract_no);
		    }
		});	
		...
		SQLButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (StringUtil2_1920x1080.isEmpty1(Sql)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
		        StringUtil2_1920x1080.SQLButton(DataVersion,Sql);
		    }
		});			
	}	
}
