...
public class HomePageWindow_1600x900  extends JFrame{
	...
	public static HomePageWindow_1600x900 getInstance() {
		HomePageWindow_1600x900 inst = new HomePageWindow_1600x900();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public HomePageWindow_1600x900() {
		super();
		initGUI();
		initTrayIcon();
		initListener();
...
//			  }
			...
			DataDisplayList.setBounds(10,10,1580,680);
			//设置背景是否透明
			...
			contractLabel.setBounds(600, 714, 70, 20);
			content.add(contractLabel);
			
			contractField = new JTextField();
			contractField.setBounds(660, 710, 240, 28);
			...
			InquiryContractButton.setBounds(920, 710, 80, 30);
			...
			SQLLabel.setBounds(600, 768, 70, 20);
			...
			SQLScroll.setBounds(660, 750, 240, 60);
			...
			SQLButton.setBounds(917, 763, 350, 30);
			...
			HangUpProcess.setBounds(1470, 780, 80, 30);
...
//				loginButton.setIcon(PictureUtil.getPicture("login_button.png"));
	...
	private void querycontrac() {
		...
		StringUtil_1600x900.btnShow_ActionPerformed(DataVersion,contract_no);
	}
	...
	private void querySql() {
		...
		StringUtil_1600x900.btnSQLButton(DataVersion,Sql);
	}	
}
